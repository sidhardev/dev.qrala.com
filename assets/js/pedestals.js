...
export const PROJECTS = [
  {
    ...
    description: 'An AI-powered real-time safety monitoring system that detects PPE compliance and safety violations using computer vision. Integrates Gemini AI for intelligent threat assessment, automated audit reports, and real-time dashboard alerts.',
    tech: ['Gemini AI', 'Computer Vision', 'Real-time Monitoring', 'Python', 'WebSocket'],
    color: 0x00f5ff,
    colorHex: '#00f5ff',
  ...
  },
  {
    id: 'sg-automobiles',
    name: 'SG Automobiles',
    subtitle: 'Full-Scale Car Marketplace',
    description: 'A comprehensive car selling platform featuring ad posting, real-time engagement tracking, complex image management with multi-upload support, and a robust Admin Panel for content moderation and analytics.',
    tech: ['PHP', 'MySQL', 'Admin Dashboard', 'Image Management', 'Real-time Analytics', 'CRUD'],
    color: 0xffb300,
    colorHex: '#ffb300',
    link: 'https://github.com/sidhardev',
    icon: 'car',
  ...
  },
  {
    ...
    subtitle: 'B2C Rewards Platform',
    description: 'A business-to-customer loyalty solution that tracks engagement, manages reward points, and drives retention. Features tier-based rewards, transaction management, and a scalable REST API backend.',
    tech: ['REST API', 'Backend Architecture', 'Transaction Management', 'Scalability', 'Database Design'],
    color: 0xc400ff,
    colorHex: '#c400ff',
    link: 'https://github.com/sidhardev',
    icon: 'coin',
